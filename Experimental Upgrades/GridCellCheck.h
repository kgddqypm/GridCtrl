...
// GridCheck单击[LPVOID:CGridCellCheck]
typedef void (CALLBACK* CallBackCheckClick) (LPVOID pParam);
...
public:
    ...
    // Check单击回调函数
    void SetCallBackCheckClick(CallBackCheckClick pFun);
...
protected:
    ...
    // Check单击回调函数
    CallBackCheckClick m_pFunCheckClick;
};
