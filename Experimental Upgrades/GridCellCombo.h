...
// GridCellCombo选项改变[LPVOID:CGridCellCombo]
typedef void (CALLBACK* CallBackComboBoxChange) (LPVOID pPara);
...
public:
    ...
    // ComboBox选项改变
    void SetCallBackComboChange(CallBackComboBoxChange pFun);
...
protected:
    ...
    CallBackComboBoxChange m_pFunComboChange;
};
