...
void CGridCellCheck::OnClick(CPoint PointCellRelative)
{
    ...
    if (m_pFunCheckClick != NULL)
    {
        m_pFunCheckClick(this);
    }
}
...
// ComboBox选项改变
void CGridCellCheck::SetCallBackCheckClick(CallBackCheckClick pFun)
{
    m_pFunCheckClick = pFun;
}
